...
workos.base_url = "http://localhost:8080"  # ← emulator

# Use the SDK as normal — requests hit the emulator
user = workos.client.user_management.create_user(email="make.universal@example.net")
...
try:
    workos.client.user_management.create_user(email="webapp4@outlook.com")
